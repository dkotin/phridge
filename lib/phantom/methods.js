 ...
 */
function openPage(url, options, resolve, reject) { /* jshint validthis: true */
    if(typeof options.userAgent != 'undefined') this.settings.userAgent = options.userAgent;
    if(typeof options.clientWidth != 'undefined' && typeof options.clientHeight != 'undefined'){
        this.viewportSize = {
            width: options.clientWidth ,
            height: options.clientWidth
        };
    }
